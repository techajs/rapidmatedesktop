...
import MultipleLocationInput from "./common/MultipleLocationInput";

const libraries = ["places"];

function EnterpriseMultipleDeliveriesSelectService() {
  ...
  const handleContinue = () => {
    ...
    navigate("/enterprises-add-pickup-details", {
      state: { order: payload },
    });
  };
